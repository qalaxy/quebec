...
<html>
	...
	<body>
		<div class="w3-container">
			...
			<p class="w3-leftbar">Station supervisor has the following message:<br />{{$error->errorCorrection()->first()->remarks}}</p>
			<p class="w3-leftbar">Click on the link below for further action.</p>
