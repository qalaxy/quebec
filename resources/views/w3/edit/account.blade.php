...
<div class="w3-panel w3-padding-small w3-card-4 w3-white w3-leftbar w3-border-light-blue" style="min-height:700px;">
  <h1 class="w3-xlarge">Edit user account</h1>
	<div class="w3-row w3-panel" style="max-width:100%;">
		@include('w3.components.notification')
		<form class="w3-container" method="POST" action="{{url('/update-account/'.$account->uuid)}}">
			@csrf
			<div class="w3-row">
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<input class="w3-input w3-border {{($errors->has('first_name')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									value="{{(old('first_name')?old('first_name'):$account->first_name)}}" />
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<input class="w3-input w3-border {{($errors->has('middle_name')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									value="{{(old('middle_name')?old('middle_name'):$account->middle_name)}}" />
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<input class="w3-input w3-border {{($errors->has('last_name')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									value="{{(old('last_name')?old('last_name'):$account->last_name)}}" />
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<input class="w3-input w3-border {{($errors->has('p_number')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									value="{{(old('p_number')?old('p_number'):$account->p_number)}}" />
					...
					<!--<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<input class="w3-input w3-border {{($errors->has('phone_number')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									value="{{(old('phone_number')?old('phone_number'):$account->phoneNumber()->first()->number)}}" />
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<input class="w3-input w3-border {{($errors->has('email')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									value="{{(old('email')?old('email'):$account->email()->first()->address)}}" />
							@if($errors->has('email'))
			...
			<div class="w3-row">
				<div class="w3-col w3-padding-small">
					<button class="w3-button w3-large w3-theme w3-hover-light-blue" type="submit" title="Update user account">Update&nbsp;<i class="fa fa-angle-right fa-lg"></i></button>
				</div>
			</div>
		</form>
	</div>
