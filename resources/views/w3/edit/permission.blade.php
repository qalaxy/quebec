...
<div class="w3-panel w3-padding-small w3-card-4 w3-white w3-leftbar w3-border-light-blue" style="min-height:700px;">
  <h1 class="w3-xlarge">Edit permission</h1>
	<div class="w3-row w3-panel" style="max-width:100%;">
		@include('w3.components.notification')
		<form class="w3-container" method="POST" action="{{($permission->uuid) ? url('/update-permission').'/'.$permission->uuid : null}}">
			@csrf
			<div class="w3-row">
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							...
							<textarea class="w3-input w3-border {{($errors->has('description')) ? 'w3-border-red' : 'w3-border-dark-gray'}}" 
									...
									name="description"
									autocomplete="off"
									rows="5">{{old('description') ? old('description') : $permission->description}}</textarea>
