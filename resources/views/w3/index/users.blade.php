...
<div class="w3-panel w3-padding-small w3-card-4 w3-white w3-leftbar w3-border-light-blue" style="min-height:700px;">
  <h1 class="w3-xlarge">Users</h1>
	<div class="w3-row w3-panel" style="max-width:100%;">
		<div class="w3-row">
			<a class="w3-button w3-blue w3-hover w3-hover-light-blue" href="{{url('/create-user')}}">CREATE</a>
		...
		<div id="search" class="w3-modal">
			<div class="w3-modal-content w3-animate-zoom w3-card-4">
				...
				<div class="w3-container w3-padding-24">
					<form class="w3-container" method="POST" action="{{url('/users')}}">
						@csrf
						<div class="w3-row">
		...
		<div class="w3-responsive w3-white w3-padding-16 w3-text-dark-gray">
			<table class="w3-table-all w3-hoverable">
				...
				<tr>
					<td><a href="{{url('user/'.$account->uuid)}}" style="text-decoration:none;">
					...
					<td><a href="{{url('user/'.$account->uuid)}}" style="text-decoration:none;">{{$account->station()->first()->name}}</a></td>
					<td><a href="{{url('user/'.$account->uuid)}}" style="text-decoration:none;">{{($account->user()->first()->status)?'Activated':'Inactive'}}</a></td>
					<td><a class="w3-button" href="{{url('edit-user/'.$account->uuid)}}" title="Edit {{$account->first_name}}"><i class="fa fa-edit fa-lg"></i></a></td>
