...
<div class="w3-panel w3-padding-small w3-card-4 w3-white w3-leftbar w3-border-light-blue" style="min-height:700px;">
  <h1 class="w3-xlarge">Error logs</h1>
	<div class="w3-row w3-panel" style="max-width:100%;">
		...
		<div id="delete" class="w3-modal"></div>
		...
		<div class="w3-responsive w3-white w3-padding-16 w3-text-dark-gray">
			<table class="w3-table-all w3-hoverable">
				...
				<tr>
					...
					<td>Pending</td>
					<td><a>Edit</a></td>
					<td><span onclick="deleteItem('uuid')">Delete</span></td>
					<!--<td><span onclick="document.getElementById('id01').style.display='block'">Delete</span></td>-->
				</tr>
				<tr>
					<td>2</td>
...
function deleteItem(uuid){
	...
	xhr.open("GET","delete-error/"+uuid);
	
	xhr.send();
	
	xhr.onreadystatechange = function(){
		if(xhr.readyState == 4 && xhr.status == 200){
			document.getElementById('delete').innerHTML = responseText;
