...
<div class="w3-panel w3-padding-small w3-card-4 w3-white w3-leftbar w3-border-light-blue" style="min-height:700px;">
  <h1 class="w3-xlarge">Stations</h1>
	<div class="w3-row w3-panel" style="max-width:100%;">
		<div class="w3-row">
			<a class="w3-button w3-blue w3-hover w3-hover-light-blue" href="{{url('/create-station')}}">CREATE</a>
		...
		<div class="w3-responsive w3-white w3-padding-16 w3-text-dark-gray">
			<table class="w3-table-all w3-hoverable">
				...
				@foreach($stations as $station)
					<tr>
						<td><a href="{{url('station/'.$station->uuid)}}" style="text-decoration:none;">{{$station->name}}</a></td>
						<td><a href="{{url('station/'.$station->uuid)}}" style="text-decoration:none;">{{$station->abbreviation}}</a></td>
						<td><a class="w3-button" href="{{url('edit-station/'.$station->uuid)}}" title="Edit {{$station->name}}"><i class="fa fa-edit fa-lg"></i></a></td>
						<td><button class="w3-button" onclick="deleteStation('{{$station->uuid}}');" title="Delete {{$station->name}}">
		...
		{{$stations->links('vendor.pagination.paginator')}}
		@endisset
	</div>
</div>
