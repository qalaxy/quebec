		...
		<form class="w3-container" method="POST" action="{{url('/store-account-station/'.$account->uuid)}}">
			...
			<div class="w3-row">
				<div class="w3-col s12 m6 l6">
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							<label class="w3-text-dark-gray">Status</label>
				...
				<div class="w3-col s12 m6 l6">
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							<label class="w3-text-dark-gray">From (mm/dd/YY)<span class="w3-text-red">*</span></label>
					...
					<div class="w3-row w3-padding-small">
						<div class="w3-col s12 m10 l10 w3-left">
							<label class="w3-text-dark-gray">To (mm/dd/YY)<span class="w3-text-red">*</span></label>
